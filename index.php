    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header" >
                    ...
                    <a  href="vaccine.php3" class="button button5">Vaccine Registration</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="assets/img/hand.png" height="70px" width="70px" class="blink" />
                </div>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <h2>Book your Health appointment today!</h2>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">Designed By Sachin <a href ="www.health.co.in/"> </a></p>
